...
<div class="block-inner light-title clearfix">
<?php if ($block->subject): ?>
  <h2 class="title light-block-title"><span><?php print $block->subject ?></span></h2>
<?php endif;?>

  <div class="content clearfix light-title-content">
