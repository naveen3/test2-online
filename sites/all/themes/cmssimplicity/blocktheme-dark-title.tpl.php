...
<div class="block-inner dark-title clearfix">
<?php if ($block->subject): ?>
  <h2 class="title dark-block-title"><span><?php print $block->subject ?></span></h2>
<?php endif;?>

  <div class="content clearfix dark-title-content">
