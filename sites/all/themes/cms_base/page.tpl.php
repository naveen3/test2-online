...
<style type="text/css">
<?php if (!theme_get_setting('use_css_for_fonts')) : ?> body {
...
<div  id="wrapper">
  <div id="wrapper-inner">
    <div id="header-wrapper" class="grid_full">
      ...
      <div id="header-middle" class="clearall grid_full">
        <div id="header-middle-inner">
          ...
          <div id="logo-title">
            <?php if ($logo): ?>
            <div id="logo"> <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home"> <img src="<?php print $logo; ?>" alt="<?php print t('Home'); ?>" id="logo-image" height="<?php print $logo_size[1];?>" width="<?php print $logo_size[0];?>" /> </a> </div>
            <?php endif; ?>
        ...
        <div id="content">
          <div id="content-inner">
            ...
            <div id="content-top4" class="clearall">
              <div class="inner"> <?php print $content_top4; ?> </div>
            </div>
            <?php endif; ?>
            ...
            <div id="content-bottom3" class="clearall">
              <div class="inner"> <?php print $content_bottom3 ?> </div>
            </div>
            <?php endif; ?>
          </div>
        </div>
    ...
    <div id="footer">
      ...
      <div id="footer-message" class="grid_full clearall">
        <div class="inner"> <?php print $footer_message; ?> </div>
      </div>
      <?php endif; ?>
    </div>
  <?php endif; ?>
        <div id="cmsquickstart" class="grid_full clearall">
